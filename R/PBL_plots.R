...
ggsave("results/Figure_1cc.pdf", plot = plots$Figure_1, width = 120, height = 130, units = "mm")
...
ggsave("results/Figure_2cc.pdf", plot = plots$Figure_2, width = 183, height = 100, units = "mm", device = cairo_pdf)


#### Figure 3 ####

plots$Figure_3 <-
  plots$one_fac$alpha_diversity

ggsave("results/Figure_3cc.pdf", plot = plots$Figure_3, width = 89, height = 100, units = "mm", device = cairo_pdf)


#### Figure 4 ####

cbn <- c("a_x_bstr", "a_x_bsim", "bstr_bsim")
plots$scatters <- list()
...
ggsave("results/Figure_4cc.pdf", plot = plots$Figure_4, width = 183, height = 183, units = "mm", device = cairo_pdf)
